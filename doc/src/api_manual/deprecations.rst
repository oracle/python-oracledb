...
.. list-table-with-summary:: Desupported in python-oracledb 26.0
    :header-rows: 1
    ...
    :name: _desupported_26_0

    * - Name
      - Comments
    * - Calling :meth:`Var.setvalue()` with strings/bytes when the variable type is a LOB type is desupported.
      - Call the method with the value returned by :meth:`Connection.createlob()` instead.
