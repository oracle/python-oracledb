...
The number of items in an IN list is limited to 65535 in Oracle AI Database
26ai, and to 1000 in earlier versions. If you exceed the limit, the database
will return an error like ``ORA-01795: maximum number of expressions in a list
is 65535``.
