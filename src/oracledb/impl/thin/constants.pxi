...
# errors
DEF TNS_ERR_INCONSISTENT_DATA_TYPES = 932
...
DEF TNS_MSG_TYPE_RENEGOTIATE = 28
DEF TNS_MSG_TYPE_COOKIE = 30
...
DEF TNS_LOB_LOC_OFFSET_FLAG_1 = 4
DEF TNS_LOB_LOC_OFFSET_FLAG_3 = 6
DEF TNS_LOB_LOC_OFFSET_FLAG_4 = 7
DEF TNS_LOB_QLOCATOR_VERSION = 4

# LOB locator flags (byte 1)
DEF TNS_LOB_LOC_FLAGS_BLOB = 0x01
DEF TNS_LOB_LOC_FLAGS_VALUE_BASED = 0x20
DEF TNS_LOB_LOC_FLAGS_ABSTRACT = 0x40

# LOB locator flags (byte 2)
DEF TNS_LOB_LOC_FLAGS_INIT = 0x08

# LOB locator flags (byte 4)
DEF TNS_LOB_LOC_FLAGS_TEMP = 0x01
DEF TNS_LOB_LOC_FLAGS_VAR_LENGTH_CHARSET = 0x80

# other LOB constants
DEF TNS_LOB_OPEN_READ_WRITE = 2
DEF TNS_LOB_PREFETCH_FLAG = 0x2000000

# base JSON constants
DEF TNS_JSON_MAX_LENGTH = 32 * 1024 * 1024
DEF TNS_JSON_MAGIC_BYTE_1 = 0xff
DEF TNS_JSON_MAGIC_BYTE_2 = 0x4a        # 'J'
DEF TNS_JSON_MAGIC_BYTE_3 = 0x5a        # 'Z'
DEF TNS_JSON_VERSION = 1
DEF TNS_JSON_FLAG_HASH_ID_UINT8 = 0x0100
DEF TNS_JSON_FLAG_HASH_ID_UINT16 = 0x0200
DEF TNS_JSON_FLAG_NUM_FNAMES_UINT16 = 0x0400
DEF TNS_JSON_FLAG_FNAMES_SEG_UINT32 = 0x0800
DEF TNS_JSON_FLAG_TINY_NODES_STAT = 0x2000
DEF TNS_JSON_FLAG_TREE_SEG_UINT32 = 0x1000
DEF TNS_JSON_FLAG_REL_OFFSET_MODE = 0x01
DEF TNS_JSON_FLAG_INLINE_LEAF = 0x02
DEF TNS_JSON_FLAG_LEN_IN_PCODE = 0x04
DEF TNS_JSON_FLAG_NUM_FNAMES_UINT32 = 0x08
DEF TNS_JSON_FLAG_IS_SCALAR = 0x10

# JSON data types
DEF TNS_JSON_TYPE_NULL = 0x30
DEF TNS_JSON_TYPE_TRUE = 0x31
DEF TNS_JSON_TYPE_FALSE = 0x32
DEF TNS_JSON_TYPE_STRING_LENGTH_UINT8 = 0x33
DEF TNS_JSON_TYPE_NUMBER_LENGTH_UINT8 = 0x34
DEF TNS_JSON_TYPE_BINARY_DOUBLE = 0x36
DEF TNS_JSON_TYPE_STRING_LENGTH_UINT16 = 0x37
DEF TNS_JSON_TYPE_STRING_LENGTH_UINT32 = 0x38
DEF TNS_JSON_TYPE_TIMESTAMP = 0x39
DEF TNS_JSON_TYPE_BINARY_LENGTH_UINT16 = 0x3a
DEF TNS_JSON_TYPE_BINARY_LENGTH_UINT32 = 0x3b
DEF TNS_JSON_TYPE_DATE = 0x3c
DEF TNS_JSON_TYPE_INTERVAL_YM = 0x3d
DEF TNS_JSON_TYPE_INTERVAL_DS = 0x3e
DEF TNS_JSON_TYPE_TIMESTAMP_TZ = 0x7c
DEF TNS_JSON_TYPE_TIMESTAMP7 = 0x7d
DEF TNS_JSON_TYPE_BINARY_FLOAT = 0x7f
DEF TNS_JSON_TYPE_OBJECT = 0x84
DEF TNS_JSON_TYPE_ARRAY = 0xc0
...
# connect flags
DEF TNS_GSO_DONT_CARE = 0x0001
DEF TNS_GSO_CAN_RECV_ATTENTION = 0x0400
DEF TNS_NSI_DISABLE_NA = 0x04
DEF TNS_NSI_SUPPORT_SECURITY_RENEG = 0x80
...
DEF TNS_CCAP_LOB_PREFETCH_DATA = 0x04
DEF TNS_CCAP_LOB_TEMP_SIZE = 0x08
DEF TNS_CCAP_LOB_PREFETCH_LENGTH = 0x40
DEF TNS_CCAP_LOB_12C = 0x80
DEF TNS_CCAP_LOB2_QUASI = 0x01
DEF TNS_CCAP_LOB2_2GB_PREFETCH = 0x04
