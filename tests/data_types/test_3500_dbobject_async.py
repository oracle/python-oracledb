...
"""
Module for testing object variables with asyncio
"""
...
async def test_data_types_3516(async_conn):
    ...
    expected_metadata = [
        ...
        ("INTERVALDSVALUE", oracledb.DB_TYPE_INTERVAL_DS, 2, 6, None),
        ("INTERVALYMVALUE", oracledb.DB_TYPE_INTERVAL_YM, 2, 0, None),
        ("CLOBVALUE", oracledb.DB_TYPE_CLOB, None, None, None),
        ("NCLOBVALUE", oracledb.DB_TYPE_NCLOB, None, None, None),
        ("BLOBVALUE", oracledb.DB_TYPE_BLOB, None, None, None),
