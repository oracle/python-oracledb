...
def test_1534(conn):
    ...
    cases = [
        ...
        (oracledb.DB_TYPE_BLOB, "test_1534B", "!", b"test_1534B!"),
        (oracledb.DB_TYPE_CLOB, b"test_1534C", b"!", "test_1534C!"),
        (oracledb.DB_TYPE_CLOB, "test_1534D", "!", "test_1534D!"),
        (oracledb.DB_TYPE_NCLOB, b"test_1534E", b"!", "test_1534E!"),
        (oracledb.DB_TYPE_NCLOB, "test_1534F", "!", "test_1534F!"),
    ]
